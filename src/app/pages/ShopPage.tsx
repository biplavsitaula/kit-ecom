...
export function ShopPage({ cartItems, onAddToCart }: ShopPageProps) {
  ...
  const products: Product[] = [
    ...
    },
    {
      ...
      rating: 4.9,
      reviews: 156,
      image: "https://images.unsplash.com/photo-1764557359097-f15dd0c0a17b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjYW1lcmElMjBwaG90b2dyYXBoeSUyMGVxdWlwbWVudHxlbnwxfHx8fDE3Njk5MDk5ODB8MA&ixlib=rb-4.1.0&q=80&w=1080",
      vendor: "TechStore",
      location: "Manhattan",
      distance: "2.1 mi",
      inStock: true,
    },
    {
      ...
      rating: 4.8,
      reviews: 445,
      image: "https://images.unsplash.com/photo-1769603891182-0316b20ce2aa?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0YWJsZXQlMjBkZXZpY2UlMjB0ZWNobm9sb2d5fGVufDF8fHx8MTc2OTk0Mjk0OHww&ixlib=rb-4.1.0&q=80&w=1080",
      vendor: "AudioPro",
      location: "Queens",
      distance: "5.2 mi",
      discount: 20,
    ...
    },
    {
      ...
      rating: 4.7,
      reviews: 289,
      image: "https://images.unsplash.com/photo-1656711081969-9d16ebc2d210?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnYW1pbmclMjBrZXlib2FyZCUyMG1lY2hhbmljYWx8ZW58MXx8fHwxNzY5OTc3MTY0fDA&ixlib=rb-4.1.0&q=80&w=1080",
      vendor: "TechStore",
      location: "Brooklyn",
      distance: "3.4 mi",
      inStock: true,
    },
    {
      ...
      rating: 4.6,
      reviews: 523,
      image: "https://images.unsplash.com/photo-1674303324806-7018a739ed11?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxibHVldG9vdGglMjBzcGVha2VyJTIwcG9ydGFibGV8ZW58MXx8fHwxNzY5OTUwNjM5fDA&ixlib=rb-4.1.0&q=80&w=1080",
      vendor: "AudioPro",
      location: "Manhattan",
      distance: "1.5 mi",
      discount: 20,
  ...
  const locations = [
    { id: 1, position: [40.7589, -73.9851] as [number, number], vendorName: "TechStore Manhattan", productCount: 4, avgPrice: 612 },
    { id: 2, position: [40.6782, -73.9442] as [number, number], vendorName: "AudioPro Brooklyn", productCount: 3, avgPrice: 443 },
    { id: 3, position: [40.7282, -73.7949] as [number, number], vendorName: "TechStore Queens", productCount: 2, avgPrice: 1049 },
    { id: 4, position: [40.7489, -73.968] as [number, number], vendorName: "FashionHub Manhattan", productCount: 1, avgPrice: 129 },
      ...
      <div>
          ...
          <div className="flex relative z-0 gap-2">
            <button
              ...
              className={`flex-1 py-2 px-4 rounded-lg flex items-center justify-center gap-2 transition-colors ${
                !showMap ? "bg-[#16A34A] text-white" : "bg-[#F9FAFB] text-[#374151]"
              }`}
            >
        ...
        <div className="h-[calc(100vh-8rem)] lg:h-[calc(100vh-4rem)]">
          <div className="h-full max-w-[1920px] mx-auto">
            <div className="h-full flex flex-col relative z-0 lg:flex-row">

              {/* Map — Left 50% on desktop, full on mobile if showMap */}
              <div className={`${showMap ? "flex" : "hidden lg:flex"} lg:w-1/2 h-full`}>
              ...
              {/* ✅ Product list — this div's scroll drives the filter hide/show */}
              <div
                className={`${!showMap ? "flex" : "hidden lg:flex"} lg:w-1/2 h-full bg-white`}
              >
                <div
                  ref={productListRef}         // ← scroll listener attached here
